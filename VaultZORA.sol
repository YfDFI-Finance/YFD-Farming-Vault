...
contract VaultZORA is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // trusted deposit token contract address (ZORA)
    address public constant trustedDepositTokenAddress = 0xD8E3FB3b08eBA982F2754988d70D57eDc0055ae6;
    // trusted reward token contract address (YFD)
    address public constant trustedRewardTokenAddress = 0x4F4F0Ef7978737ce928BFF395529161b44e27ad9;
    // reward rate
    uint public rewardRatePercentX100 = 25e2;
    ...
    uint public adminCanClaimAfter = 600 days;
